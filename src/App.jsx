      ...
      <div className="w-full max-w-6xl mx-auto mt-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 p-6 rounded-3xl bg-gradient-to-r from-blue-900/60 via-black/80 to-blue-900/60 border-2 border-blue-700/30 shadow-2xl mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600">NFT Generator Pro</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-black/80 rounded-2xl p-6 border border-blue-700/40 flex flex-col gap-3">
              ...
              <div className="flex gap-3">
                {Object.entries(BUTTON_THEMES).map(([key, theme]) => (
                  ...
                  >
                    <span className={`w-3 h-3 rounded-full shadow ${theme.led}`}></span>
                    {theme.icon}
                    {theme.label}
                  </button>
                ))}
            ...
            <div className="bg-black/80 rounded-2xl p-6 border border-blue-700/40">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <span className={`w-3 h-3 rounded-full shadow ${buttonLed}`}></span>
            ...
            <div className="bg-black/80 rounded-2xl p-6 border border-blue-700/40">
              ...
              <input type="text" value={name} onChange={e => setName(e.target.value)} className="w-full bg-black/70 text-white px-5 py-4 rounded-xl mb-4 font-semibold border-2 border-slate-700/50 focus:border-blue-500/60 transition-all outline-none shadow-inner text-lg" placeholder="Enter NFT Name" />
              <div className="grid grid-cols-2 gap-4">
                <select value={rarity} onChange={e => setRarity(e.target.value)} className="bg-black/70 text-white px-5 py-4 rounded-xl font-bold border-2 border-slate-700/50 focus:border-blue-500/60 transition-all outline-none cursor-pointer shadow-inner text-lg" style={{ color: rarityTheme.text }}>
                  {Object.keys(RARITY_COLORS).map(r => (
                    <option key={r} value={r} style={{ color: RARITY_COLORS[r].text }}>{r}</option>
                  ))}
                </select>
                <div className="flex items-center gap-3 bg-black/70 px-5 rounded-xl border-2 border-slate-700/50 shadow-inner">
